(function() {
	...
	angular.module('ngDrupalServicesTests', [ 'ui.router', 'ui.bootstrap', 'ngAnimate', 'ngMessages', 'commons.directives.whenReady', 'commons.directives.startsWith', 'commons.directives.endsWith', 'commons.directives.contains',

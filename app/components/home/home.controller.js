...
angular
    .module('ngDrupalServicesTests.home.controller', ['ngDrupal7Services-3_x.resources.system.resource', 'ngDrupal7Services-3_x.resources.system.channel', 'ngDrupal7Services-3_x.commons.baseChannel'])
    .controller('HomeController', HomeController);

	HomeController.$inject = ['$scope', 'SystemResource', 'SystemChannel', 'BaseChannel'];

	/** @ngInject */ 
	function HomeController($scope, SystemResource, SystemChannel, BaseChannel) { 
		console.log('BaseChannel: ', BaseChannel);
